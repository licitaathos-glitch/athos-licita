...
export const COLS_EMPENHOS = ['id','empresaId','empresaNome','ataId','numeroAta','orgao',
  ...
  'custoUnitario','status','notaFiscal','dataFaturamento','dataPagamento','observacao',
  'anexoDriveId','anexoDriveUrl','anexoNome','criadoEm']
...
// Converte valores para número aceitando dois formatos:
//  - BR digitado à mão ("1.234,56") — ponto é milhar, vírgula é decimal;
//  - vindo de <input type="number"> ("1234.56") — ponto já É o decimal, sem milhar.
// A vírgula é o sinal de que é formato BR; sem vírgula, o ponto fica intacto
// (antes isso era removido sempre, inflando por 10x/100x qualquer valor com
// centavos vindo de campo numérico — ex: empenhos, lances por item).
export const num = v => {
