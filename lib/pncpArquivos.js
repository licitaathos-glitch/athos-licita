...
// Normaliza a lista crua do PNCP — usada tanto na busca direta quanto na que
// passa pelo Apps Script, para as duas devolverem exatamente o mesmo formato
export function montarArquivos(lista, base) {
