...
export const MENUS = [
  ...
  { key: 'agenda',        label: 'Agenda',               href: '/dashboard/agenda',             icon: '📅', fixo: true },
  ...
  { key: 'atas',          label: 'Atas e Contratos',    href: '/dashboard/atas',               icon: '🗂️' },
  ...
  { key: 'informacoes',   label: 'Informações Importantes', href: '/dashboard/informacoes',    icon: '📌' },
