  ...
  },
  {
    ...
    itens: [
      ...
      { k: 'vistoria', label: 'Vistoria técnica',
        pergunta: 'Se houver vistoria (obrigatória ou facultativa), conseguimos realizá-la no prazo?',
        ajuda: 'Confira se é presencial e o prazo limite antes da sessão.' },
...
// usado na tela de Em análise, no resumo completo (PDF) e no e-mail pra
// empresa/fornecedor. Recebe o objeto de respostas (chkDados).
export function gerarResumoTexto(chkDados) {
  ...
  // amostra/vistoria, depois o resto.
  const ordem = ['qualTecnica', 'qualEconFin', 'prazoEntrega', 'pagamento', 'amostra', 'vistoria',
    'certidoes', 'declaracoes', 'frete', 'garantia', 'penalidades', 'preco', 'orgao']
