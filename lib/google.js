...
// Cabeçalho cru da aba — útil para diagnosticar campo que "não salva": quase
// sempre é nome de coluna divergente (espaço sobrando, caixa diferente).
export async function cabecalhoAba(nome) {
